...
all the images are in the assets folder and similar named images

- Logo (in the assets folder as logo.png) aligned to the left ("DEVCONF 2026")
...
- Centered bold heading ("Code. _Connect_. Create") — style one word (e.g. "Connect") in italics for emphasis
